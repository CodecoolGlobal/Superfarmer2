...
const stockGrowth = function (bank, user) {
    console.log("in stockGrowth function the received stock is:", user, animal);
    let animal;
    for (animal of Object.keys(user)) {
    ...
    console.log("at the end of the StockGrowth the bank is :", bank, animal);
    return [bank, user];
};
